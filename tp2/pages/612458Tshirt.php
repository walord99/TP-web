...
<body>
    ...
    <main class="container">
        ...
        foreach ($events as $event) {
            echo "<a href='modifier-event?id=" . $event["id"] . "'>Modifier l'événement : ".$event["name"]."</a></br>";
        }
        ?>
        ...
        <form id="rendered-form" method="post" action="/actions/create_event.php">
            <div class="rendered-form">
                <div class="formbuilder-text form-group field-name"><label for="name" class="formbuilder-text-label">Nom<span class="formbuilder-required">*</span></label><input type="text" class="form-control" name="name" access="false" id="name" required="required" aria-required="true"></div>
                ...
                <div class="formbuilder-date form-group field-date"><label for="date" class="formbuilder-date-label">Date<span class="formbuilder-required">*</span></label><input type="date" class="form-control" name="date" access="false" id="date" required="required" aria-required="true"></div>
                <div class="formbuilder-number form-group field-cost"><label for="cost" class="formbuilder-number-label">Prix<span class="formbuilder-required">*</span></label><input type="number" class="form-control" name="cost" access="false" id="cost" required="required" aria-required="true"></div>
                <div class="formbuilder-text form-group field-website"><label for="website" class="formbuilder-text-label">Site
                        web<br><span class="formbuilder-required">*</span></label><input type="text" class="form-control" name="website" access="false" id="website" required="required" aria-required="true"></div>
                ...
                <div class="formbuilder-button form-group field-submit"><button type="submit" class="btn-primary btn" name="action" access="false" id="action" value="create_event">Envoyer</button></div>
            </div>
        </form>
    </main>
